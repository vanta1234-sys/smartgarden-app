    ...
    <div id="newsletter-signup" className="bg-gradient-to-r from-emerald-950/60 via-slate-900 to-teal-950/60 border border-emerald-500/20 rounded-2xl p-6 space-y-3">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-emerald-700 hover:bg-emerald-600 disabled:opacity-60 text-white font-bold px-5 py-2.5 rounded-xl text-sm transition-colors cursor-pointer"
        >
