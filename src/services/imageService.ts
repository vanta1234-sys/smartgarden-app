...
export const CURATED_GARDENING_PHOTOS: CuratedPhoto[] = [
  ...
  // --- Olives and table-olive processing -----------------------------------
  //
  // Added 2026-09-21 after the first long-form render on brining table olives came back
  // with three on-topic frames out of forty-six: the rest were oyster mushrooms, a snake
  // plant in a living room, potting soil and an aubergine. The catalogue covered growing
  // plants and nothing about processing what they produce, so the matcher fell through to
  // neutral and fallback imagery for most of a ten-minute video.
  //
  // Every one of these was downloaded and looked at before it was written down. The search
  // that produced them returned "green apple fruit beside orange carrot" and "a pile of
  // yellow nuts" under the word olives, and a search for fermentation jars offered pickled
  // red cabbage and two jars of kombucha — all of which would have been exactly the same
